...
export default function Support() {
    return (
        <div className="relative isolate overflow-hidden bg-gray-900 pt-20 sm:pb-20">
            <img
                alt=""
            ...
            <div className="flex flex-wrap md:text-left text-center order-first pb-4 md:px-10 lg:px-20">
                <div className="max-w-4xl border border-gray-500 p-6 rounded-lg">
                    <h2 className="-mt-[54px] w-fit backdrop-blur p-2 pl-4 pr-4 rounded-2xl border-b text-2xl font-semibold tracking-tight text-white sm:text-4xl">About Sprnt ...</h2>
                    <p className="mt-4 text-sm text-pretty text-gray-400 sm:text-base text-justify">
            ...
            <div className="absolute w-full bottom-0 md:px-20">
                <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <p className="text-base text-gray-400 ml-auto mt-3">Copyrights © 2025 Sprnt Online Solutions 
                        {/* — */}
                    ...
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        <a href="https://www.facebook.com/" className=" text-gray-400 border-gray-400 hover:text-blue-600 rounded-full border-2 hover:border-blue-600 p-1.5">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </a>
                        <a href="https://www.twitter.com/" className="ml-3 text-gray-400  border-gray-400 hover:text-indigo-600 rounded-full border-2 hover:border-indigo-600 p-1.5">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/" className="ml-3 text-gray-400  border-gray-400 hover:text-purple-600 rounded-full border-2 hover:border-purple-600 p-1.5">
                            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                                <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                            </svg>
                        </a>
                        <a href="https://www.linkedin.com/" className="ml-3 text-gray-400 rounded-full border-2 border-gray-400 p-1.5 hover:text-cyan-400 hover:border-cyan-400">
